          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: List.generate(SettingsState.accentColors.length, (index) {
                  final color = SettingsState.accentColors[index];
                  final isSelected = settings.accentColorIndex == index;

                  return GestureDetector(
                    onTap: () => _settingsCubit.setAccentColor(index),
              ...
              children: [
                ...
                ListTile(
                  ...
                  trailing: isSpanish
                      ...
                      : null,
                  onTap: () {
                    _settingsCubit.setLocale(const Locale('es'));
                    Navigator.pop(ctx);
                  },
                ),
                ListTile(
                  ...
                  trailing: !isSpanish
                      ...
                      : null,
                  onTap: () {
                    _settingsCubit.setLocale(const Locale('en'));
                    Navigator.pop(ctx);
                  },
                ),
                const SizedBox(height: 16),
