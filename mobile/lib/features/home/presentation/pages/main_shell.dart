...
import '../../../shared_tasks/presentation/pages/groups_page.dart';
...
class _MainShellState extends State<MainShell> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final labels = [l10n.today, l10n.tasks, l10n.profile];
    final icons = [RadixIcons.Home, RadixIcons.Checkbox, RadixIcons.Person];
