...
import 'package:taskly/shared/widgets/ui/app_colors.dart';

abstract class AppTheme {
  static Color _accentColor = AppColors.primary;
  ...
  static ThemeData lightTheme(Color accentColor) {
    ...
    final bool isDefaultAccent = accentColor.value == AppColors.primary.value;
    ...
    return ThemeData(
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        backgroundColor: AppColors.background,
        selectedItemColor: AppColors.foreground,  // Negro para item seleccionado
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        labelTextStyle: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return GoogleFonts.inter(
              fontSize: 12,
              fontWeight: FontWeight.w500,
              color: AppColors.foreground,  // Negro
            );
          }
          return GoogleFonts.inter(
            fontSize: 12,
        ...
        iconTheme: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return const IconThemeData(color: AppColors.foreground, size: 24);  // Negro
          }
  ...
  static ThemeData darkTheme(Color accentColor) {
    ...
    return ThemeData(
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        backgroundColor: AppColors.backgroundDark,
        selectedItemColor: AppColors.foregroundDark,  // Blanco para item seleccionado
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        labelTextStyle: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return GoogleFonts.inter(
              fontSize: 12,
              fontWeight: FontWeight.w500,
              color: AppColors.foregroundDark,  // Blanco
            );
          }
          return GoogleFonts.inter(
            fontSize: 12,
        ...
        iconTheme: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return const IconThemeData(color: AppColors.foregroundDark, size: 24);  // Blanco
          }
